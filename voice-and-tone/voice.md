---
description: Meridian Aura is friendly, encouraging, and informative.
---
...
| Like this                                                                                    | Not this                                                                                                                                                                                   |
| -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| :white\_check\_mark: _Enter at least 8 characters, including a captial letter and a number._ | :no\_entry: For security reasons, you didn’t enter a strong enough password. Please check that you password has eight digits. You also need one captial letter. You can also use a symbol. |
